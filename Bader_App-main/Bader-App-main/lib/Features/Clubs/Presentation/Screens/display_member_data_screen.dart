...
class DisplayMemberDataScreen extends StatelessWidget {
  ...
  DisplayMemberDataScreen({Key? key, required this.userEntity})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    ClubsCubit.getInstance(context)
        .getDataAboutSpecificMember(memberID: userEntity.id!);
    _nameController.text = userEntity.name!;
    _volunteerHoursController.text = userEntity.volunteerHours != null
        ? userEntity.volunteerHours.toString()
        : 0.toString();
          ...
          body: Padding(
              ...
              child: BlocConsumer<ClubsCubit, ClubsStates>(
                ...
                builder: (context, state) {
                  return state is GetMemberDataSuccessState
                      ...
                      : state is GetMemberDataWithFailureState
                          ? Center(
                              child: Text(
                                state.message,
                                style: TextStyle(
