...
class UpdateMeetingScreen extends StatelessWidget {
  ...
  UpdateMeetingScreen({Key? key, required this.meetingEntity})
      : super(key: key);
                ...
                children: [
                  SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        _textField(
                            controller: _nameController, title: 'اسم الاجتماع'),
                        _textField(
                            controller: _descriptionController, title: 'الوصف'),
                        _textField(
                            controller: _dateController,
                            title: 'التاريخ',
                            onTap: () async => _dateController.text = Jiffy(
                                    await Constants.selectDate(
                                        context: context))
                                .yMMMd),
                        _textField(
                            ...
                            onTap: () async {
                              TimeOfDay? timeNow =
                                  await Constants.selectTime(context: context);
