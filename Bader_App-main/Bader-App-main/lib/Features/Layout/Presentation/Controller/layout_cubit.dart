...
class LayoutCubit extends Cubit<LayoutStates> {
  ...
  void openPdf({required String link}) async {
    ...
    if (launchSuccess == false)
      emit(ErrorDuringOpenPdfState(
          message: "حدث خطأ ما عند محاولة فتح الرابط يرجى المحاولة لاحقا"));
  }
  ...
  Future<void> uploadReport(
    ...
    if (pdfUrl != null) {
      ...
      emit(UploadReportToAdminWithFailureState(
          message: 'حدث خطأ اثناء رفع الملف يرجى المحاولة لاحقا'));
    }
  }
  ...
  Future<void> getMyData({ClubsCubit? clubsCubit}) async {
    // TODO: ClubsCubit? clubsCubit not required عشان راح نشوف قيمه فقط لو جاء لنا notification فيه اذا صرت قائد علي نادي to getDataAboutClubILead from this cubit
