...
class ProfileScreen extends StatelessWidget {
                              ...
                              children: [
                                Stack(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      backgroundColor:
                                          cubit.userData!.idForClubLead != null
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      _titleBehindDescriptionItem(
                                          title: "البريد الإلكتروني",
                                          description: cubit.userData!.email!),
                                      SizedBox(
                                        height: 2.h,
                                      ),
                                      _titleBehindDescriptionItem(
                                          title: "رقم الهاتف",
                                          description:
                                              cubit.userData!.phone.toString()),
                                      SizedBox(
                                        height: 2.h,
                                      ),
                                      _titleBehindDescriptionItem(
                                          title: "الجنس",
                                          description: cubit.userData!.gender!),
                                      SizedBox(
                                        height: 2.h,
                                      ),
                                      _titleBehindDescriptionItem(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        _titleBehindDescriptionItem(
                                            ...
                                            description:
                                                "${cubit.userData!.volunteerHours ?? 0}"),
                                        SizedBox(
                                          height: 2.h,
                                        ),
                                        _titleBehindDescriptionItem(
                                            title: "بداية العضوية",
                                            description: cubit.userData!
                                                .membershipStartDate!),
                                      ],
                                    ),
                                  )
  ...
  Widget _titleBehindDescriptionItem(
