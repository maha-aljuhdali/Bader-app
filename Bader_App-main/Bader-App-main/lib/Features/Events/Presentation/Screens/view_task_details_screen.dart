...
class ViewTaskDetailsScreen extends StatelessWidget {
  ...
  final TextEditingController _numOfRegisteredController =
      TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    _eventName.text = taskEntity.forPublicOrSpecificToAnEvent
        ? "غير خاص بفعالية معينة"
      ...
      child: SafeArea(
        ...
        body: Padding(
            ...
            child: ListView(
              ...
              children: [
                _textFieldItem(
                    controller: _nameController, labelText: 'اسم المهمة'),
                _textFieldItem(
                    controller: _eventName, labelText: 'اسم الفعالية'),
                _textFieldItem(
                    maxLines: 5,
                ...
                _textFieldItem(
                    controller: _numOfRegisteredController,
                    labelText: 'عدد المسجلين'),
                _textFieldItem(
