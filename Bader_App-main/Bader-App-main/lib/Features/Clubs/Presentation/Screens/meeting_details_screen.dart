...
class MeetingDetailsScreen extends StatelessWidget {
  ...
  MeetingDetailsScreen({Key? key, required this.meetingEntity})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Directionality(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: const Text('تفاصيل الإجتماع'),
          ),
          body: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _textFieldItem(
                              ...
                              maxLines: 3),
                          _textFieldItem(
                              controller: _dateController, title: 'التاريخ'),
                          _textFieldItem(
                              controller: _timeController, title: 'الوقت'),
                          _textFieldItem(
                          ...
                          DefaultButton(
                            ...
                            onTap: () {
                              LayoutCubit.getInstance(context)
                                  .openPdf(link: meetingEntity.link!);
                            },
                            title: "فتح الرابط",
                          )
                        ],
