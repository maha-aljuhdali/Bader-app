...
class LayoutRemoteDataSource {
  ...
  Future<Unit> logout({
    ...
    try {
      ...
      layoutCubit.bottomNavIndex =
          0; // TODO: عشان لما يجي يسوي تسجيل دخول يدخل علي ال Home مو Profile لان اخر قيمه له هي 2
      return unit;
    } on FirebaseException catch (e) {
      throw ServerException(exceptionMessage: e.code);
    }
  ...
  // Todo: topicName => في حاله لو راح ارسل لناس مسوية subscribe to specific Topic
