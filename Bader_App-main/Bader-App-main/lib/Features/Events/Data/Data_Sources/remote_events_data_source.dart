...
class RemoteEventsDataSource {
  ...
  // TODO: راح ترجع id حق التاسكات اللي انا رسلت طلب تسجيل فيها بالفعل
    ...
    try {
      ...
      await layoutCubit.sendNotification(
          ...
          notifyContent: respondStatus
              ? "لقد تم قبول طلبك للمصادقة في مهمة ${taskEntity.name}"
              : "لقد تم رفض طلبك للمصادقة في مهمة ${taskEntity.name}",
      ...
      if (respondStatus) // TODO: Request Accepted
      {
        ...
        volunteerHoursForUser +=
            taskEntity.hours; // TODO: راح تضيف عدد ساعات التاسك للشخص هذا
